...
public class BankingSteps
{
    ...
    public void WhenTheUserWithdraws(string amount)
    {
        loginPage.PerformWithdraw(amount);
    }
    ...
    public void ThenTheBalanceShouldBeUpdatedCorrectly()
    {
        ...
        Assert.That(finalBalance, Is.EqualTo(expectedBalance.ToString()), "The balance is not updated correctly after withdrawal.");
    }
